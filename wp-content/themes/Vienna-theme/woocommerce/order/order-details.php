...
<header>
	<h2 class="pm-customer-details-title"><?php _e( 'Customer details', 'woocommerce' ); ?></h2>
</header>
...
<?php endif; ?>
		...
		<header class="title">
			<h3 class="pm-billing-address-title"><?php _e( 'Billing Address', 'woocommerce' ); ?></h3>
		</header>
		<address><p>
			<?php
...
<?php if ( get_option( 'woocommerce_ship_to_billing_address_only' ) === 'no' && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="col-2">
		...
		<header class="title">
			<h3 class="pm-shipping-address-title"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h3>
		</header>
		<address><p>
			<?php
...
<a target="_self" id="pm-print-btn" class="pm-rounded-btn" href="#"><?php _e('Print page','viennatheme'); ?> &nbsp;<i class="fa fa-print"></i></a>
