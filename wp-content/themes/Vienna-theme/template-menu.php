    ...
    <div class="row">
        ...
        <div class="col-lg-12 pm-containerPadding-bottom-40">
            ...
            <div class="pm-featured-header-container">
                ...
                <div class="pm-featured-header-title-container" style="background-image:url(<?php echo $menu_panel_image['url'] ?>);">
                    <p class="pm-featured-header-title"><?php echo $menu_panel_title; ?></p>
                    <p class="pm-featured-header-message"><?php echo $menu_panel_message; ?></p>
                </div>
        ...
        <div id="pm-isotope-item-container">
            ...
            <?php endwhile; else: ?>
                 <p><?php _e('No menus were found.', 'viennatheme'); ?></p>
            <?php endif; ?>
...
<!-- Load more -->
<?php //if($published_posts > $eventsPostsDisplay) { ?>
