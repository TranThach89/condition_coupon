...
//                }
            ...
            public function _options_page_html() {
                 ...
                 */
                echo '<div class="redux-save-warn notice-yellow"><strong>' . apply_filters( "redux-changed-text-{$this->args['opt_name']}", __( 'Settings have changed, you should save them! - W`P`L`O`C`K`E`R`.`C`O`M`', 'redux-framework' ) ) . '</strong></div>';
