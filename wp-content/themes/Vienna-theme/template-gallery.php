    ...
    <div class="row">
        ...
        <div class="col-lg-12 pm-containerPadding-bottom-40">
            ...
            <div class="pm-featured-header-container">
            	...
            	<?php 
					...
					//print_r($gallery_panel_image);
				
				?>
            
                <!-- Featured panel header -->
                <div class="pm-featured-header-title-container" style="background-image:url(<?php echo $gallery_panel_image['url'] ?>);">
                    <p class="pm-featured-header-title"><?php echo $gallery_panel_title; ?></p>
                    <p class="pm-featured-header-message"><?php echo $gallery_panel_message; ?></p>
                </div>
        ...
        <?php
			...
			$arguments = array(
				...
				'paged' => $paged,
				//'posts_per_page' => -1,
				'posts_per_page' => $gallery_posts_per_load,
        ...
        <div id="pm-isotope-item-container">
            ...
            <?php endwhile; else: ?>
                 <p><?php _e('No gallery posts were found.', 'viennatheme'); ?></p>
            <?php endif; ?>
...
<!-- Load more -->
<?php if($published_posts > $gallery_posts_per_load) { ?>
            ...
            <div class="col-lg-12">
                <div class="pm-load-more-container">
                	<div class="pm-load-more-container-count">
                    	<p><?php _e('Viewing', 'viennatheme') ?> <span class="pm-load-more-container-current-count"><?php echo $gallery_posts_per_load; ?></span> <?php _e('of', 'viennatheme') ?> <?php echo $published_posts; ?></p>
                    </div>  
                    <div class="pm-load-more-container-icon">
                        <a href="#" class="pm-rounded-btn" id="pm-load-more" name="galleries"><span><?php _e('Load More', 'viennatheme') ?></span></a>
                    </div>
                </div>
            </div>
        </div>
